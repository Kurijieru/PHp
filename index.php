    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
<?php
	$ret=mysqli_query($con,"select * from students_tbl");
	$cnt=1;
...
<!--Fetch the Records -->
                    <tr>
                        ...
                        <td><img src="profilepics/<?php  echo $row['StudentPhoto'];?>" width="80" height="80"></td>
                        <td><?php  echo $row['First_Name'];?> <?php  echo $row['MI'];?> <?php  echo $row['Last_Name'];?></td>
